...
range_graph[0].plot(C_no_sc1a, color="blue", label='C/No SC1A', ls='--')
range_graph[0].plot(C_no_eve, color="orange", label='C/No Eve', marker='x', ls=(0, (5, 10)))
range_graph[0].set_title("C/No comprarision between SC1A and Eve")
range_graph[0].set_ylabel('C/No [dB]')
range_graph[0].set_xlabel('Simulation Step')
range_graph[0].legend()

range_graph[1].plot(Eb_no_sc1a, color="blue", label='Eb/No SC1A', ls='--')
range_graph[1].plot(Eb_no_eve, color="orange", label='Eb/No Eve', marker='x', ls=(0, (5, 10)))
range_graph[1].set_title("Eb/No comprarision between SC1A and Eve")
